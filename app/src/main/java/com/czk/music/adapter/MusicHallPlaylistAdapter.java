...
public class MusicHallPlaylistAdapter extends RecyclerView.Adapter<MusicHallPlaylistAdapter.ViewHolder> {
    ...
    public MusicHallPlaylistAdapter(@NonNull Context context, List<PlayListSimple> playListSimples) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       return new MusicHallPlaylistAdapter.ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_recycler_playlist_hall,parent,false));
    }
    ...
    public void changePlayListSimples(List<PlayListSimple> playListSimples){
        this.playListSimples = playListSimples;
